...
function FlashcardTestPage() {
    ...
    // 測驗狀態
    const [testMode, setTestMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [testCompleted, setTestCompleted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // 統計
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FlashcardTestPage.useEffect": ()=>{
            const fetchData = {
                "FlashcardTestPage.useEffect.fetchData": async ()=>{
                    ...
                    setDeck(deckData);
                    const { data: cardsData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("flashcards").select("*").eq("deck_id", deckId);
                    if (cardsData) {
                        setCards(cardsData);
                    }
                    setLoading(false);
                }
            }["FlashcardTestPage.useEffect.fetchData"];
            fetchData();
        }
    }["FlashcardTestPage.useEffect"], [
        deckId,
    ...
    const startTest = (mode)=>{
        ...
        if (mode === "fill_front") {
            // 填充題：不需要選項
            setQuestions(shuffledCards.map((card)=>({
                    card
                })));
        } else {
            // 選擇題：生成選項
            const questionsWithOptions = shuffledCards.map((card)=>{
                ...
                const wrongAnswers = wrongOptions.map((c)=>mode === "choose_back" ? c.back : c.front);
                // 合併並打亂選項
                const allOptions = [
                    correctAnswer,
                    ...wrongAnswers
        ...
        children: [
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: testMode === "choose_front" ? "背面" : "正面"
                        }, void 0, false, {
                            fileName: "[project]/app/(dashboard)/dashboard/flashcards/[deckId]/page.tsx",
                            lineNumber: 411,
                            columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "text-xl text-center text-gray-800 whitespace-pre-wrap",
                            children: testMode === "choose_front" ? question.card.back : question.card.front
                        }, void 0, false, {
                            fileName: "[project]/app/(dashboard)/dashboard/flashcards/[deckId]/page.tsx",
                            lineNumber: 414,
                            columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            onClick: ()=>{
                                ...
                                const lang = isBack ? deck?.back_lang || "auto" : deck?.front_lang || "auto";
                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$speech$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["speakWithLang"])(text, lang);
                            },
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: isCorrect ? "text-green-700 font-medium" : "text-red-700 font-medium",
                                        children: isCorrect ? "正確！" : "錯誤"
                                    }, void 0, false, {
                                        fileName: "[project]/app/(dashboard)/dashboard/flashcards/[deckId]/page.tsx",
                                        lineNumber: 464,
                                        columnNumber: 17
                ...
                children: question.options?.map((option, index)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center font-medium text-gray-600",
                                    children: [
                                        "A",
                                        "B",
                                        "C",
                                ...
                                showResult && index === question.correctIndex && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2d$big$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle$3e$__["CheckCircle"], {
                                    className: "w-5 h-5 text-green-600"
                                }, void 0, false, {
                                    fileName: "[project]/app/(dashboard)/dashboard/flashcards/[deckId]/page.tsx",
                                    lineNumber: 507,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: !showResult ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                    ...
                    disabled: testMode === "fill_front" ? !userAnswer.trim() : selectedOption === null,
                    ...
                    className: "bg-blue-600 hover:bg-blue-700 px-8",
                    children: currentIndex < questions.length - 1 ? "下一題" : "查看結果"
                }, void 0, false, {
                    fileName: "[project]/app/(dashboard)/dashboard/flashcards/[deckId]/page.tsx",
                    lineNumber: 534,
                    columnNumber: 11
...
_s(FlashcardTestPage, "XjS37rnnmbumPZ7QFiA7ntVsGwI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = FlashcardTestPage;
var _c;
__turbopack_context__.k.register(_c, "FlashcardTestPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_3ef50d2f._.js.map